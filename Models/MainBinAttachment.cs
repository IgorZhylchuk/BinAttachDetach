...
namespace BinAttachmentApp.Models
{
    public class MainBinAttachment
    {
      ...
      //  public List<BinsModel> Bins { get; set; }
        ...
        public MainBinAttachment()
        {
            ...
            Machines = new List<MachineModel>()
            {
                ...
                new MachineModel {Id = 4, Name = "Process machine № 4", ProcessModelId = 1},

                new MachineModel {Id = 5, Name = "Packing machine № 1", ProcessModelId = 2},
                new MachineModel {Id = 6, Name = "Packing machine № 2", ProcessModelId = 2},
                new MachineModel {Id = 7, Name = "Packing machine № 3", ProcessModelId = 2},
                new MachineModel {Id = 8, Name = "Packing machine № 4", ProcessModelId = 2},
